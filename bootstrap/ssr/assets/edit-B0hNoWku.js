...
function EditReport({ report, accounts }) {
  const { data, setData, put, processing, errors } = useForm({
    name: report.name || "",
    type: report.type || "summary",
    description: report.description || "",
    account_ids: report.accounts?.map((a) => a.id) || []
  });
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: [
    ...
    /* @__PURE__ */ jsx(Head, { title: `Modifier ${report.name}` }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-gray-600 dark:text-gray-400", children: "Modifiez la configuration du rapport" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Modifiez le type de rapport et les comptes associés" })
        ] }),
