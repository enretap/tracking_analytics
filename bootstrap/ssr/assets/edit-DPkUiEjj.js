...
function UsersEdit({ user, accounts }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: [
    ...
    /* @__PURE__ */ jsx(Head, { title: `Modifier ${user.name}` }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 dark:text-gray-100", children: "Modifier l'utilisateur" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-gray-600 dark:text-gray-400", children: user.email })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Modifiez les informations de l'utilisateur" })
        ] }),
