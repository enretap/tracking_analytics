...
import { useSyncExternalStore, useState, useEffect, useCallback, Fragment as Fragment$1 } from "react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { XIcon, PanelLeftIcon, ChevronRight, Loader2, FileText, CheckIcon, Settings, LogOut, ChevronsUpDown, BookOpen, LayoutGrid, Users, Zap } from "lucide-react";
import { c as cn, B as Button, r as resolveUrl, q as queryParams, l as logout, d as dashboard } from "./button-VCvxHZJY.js";
...
import { F as FlashToast } from "../ssr.js";
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(
              ...
              {
                "data-sidebar": "sidebar",
                className: "bg-gradient-to-b from-amber-50 via-yellow-50 to-orange-50 dark:from-slate-900 dark:via-amber-950 dark:to-yellow-950 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm",
                children
              }
            )
          }
...
function SidebarMenuSubButton({
  ...
  return /* @__PURE__ */ jsx(
    Comp,
    {
      ...
      "data-active": isActive,
      className: cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex min-h-7 min-w-0 -translate-x-px items-center gap-2 rounded-md px-2 py-1 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
...
function AppContent({
  ...
  if (variant === "sidebar") {
    return /* @__PURE__ */ jsx(SidebarInset, { className, ...props, children: /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col gap-4 p-4 pt-0", children }) });
  }
  return /* @__PURE__ */ jsx(
    "main",
    {
  ...
  const isItemActive = (itemHref) => {
    ...
    if (currentUrl.startsWith(itemUrl + "/")) {
      const hasMoreSpecificMatch = items.some((otherItem) => {
        ...
        return otherUrl !== itemUrl && otherUrl.length > itemUrl.length && (currentUrl === otherUrl || currentUrl.startsWith(otherUrl + "/"));
      });
      return !hasMoreSpecificMatch;
    }
    return false;
  };
  return /* @__PURE__ */ jsx(SidebarGroup, { className: "px-2 py-0", children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => {
      ...
      return /* @__PURE__ */ jsx(
        Collapsible,
        {
          ...
          children: /* @__PURE__ */ jsxs(SidebarMenuItem, { children: [
            ...
            /* @__PURE__ */ jsx(CollapsibleContent, { children: /* @__PURE__ */ jsx(SidebarMenuSub, { children: loadingReports ? /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsxs(SidebarMenuSubButton, { disabled: true, children: [
              /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }),
              /* @__PURE__ */ jsx("span", { children: "Chargement..." })
            ] }) }) : reports.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
              reports.slice(0, 5).map((report) => /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsxs(Link, { href: `/reports/${report.id}`, children: [
                /* @__PURE__ */ jsx(FileText, { className: "h-4 w-4" }),
                /* @__PURE__ */ jsx("span", { children: report.name })
              ] }) }) }, report.id)),
              reports.length > 5 && /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/reports", className: "text-muted-foreground", children: /* @__PURE__ */ jsxs("span", { children: [
                "Voir tous les rapports (",
                reports.length,
                ")"
              ] }) }) }) })
            ] }) : /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/reports", className: "text-muted-foreground", children: /* @__PURE__ */ jsx("span", { children: "Aucun rapport" }) }) }) }) }) })
          ] })
        },
        item.title
      );
        ...
        Collapsible,
        {
          ...
          children: /* @__PURE__ */ jsxs(SidebarMenuItem, { children: [
            ...
            /* @__PURE__ */ jsx(CollapsibleContent, { children: /* @__PURE__ */ jsxs(SidebarMenuSub, { children: [
              /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/settings/platforms", children: /* @__PURE__ */ jsx("span", { children: "Plateformes" }) }) }) }),
              /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/settings/accounts", children: /* @__PURE__ */ jsx("span", { children: "Comptes" }) }) }) }),
              /* @__PURE__ */ jsx(SidebarMenuSubItem, { children: /* @__PURE__ */ jsx(SidebarMenuSubButton, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/settings/reports", children: /* @__PURE__ */ jsx("span", { children: "Rapports" }) }) }) })
            ] }) })
          ] })
        },
        item.title
...
function AppLogoIcon({ size = 32, className = "" }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      width: size,
      ...
      children: [
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "logoGradient", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
          /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "#F59E0B" }),
          /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: "#FBBF24" }),
          /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "#F97316" })
        ] }) }),
        /* @__PURE__ */ jsx("rect", { width: "48", height: "48", rx: "12", fill: "url(#logoGradient)" }),
        /* @__PURE__ */ jsx("path", { d: "M14 20L20 16L28 26L34 20", stroke: "white", strokeWidth: "2", strokeLinecap: "round" }),
        /* @__PURE__ */ jsx("circle", { cx: "14", cy: "20", r: "2", fill: "white" }),
        /* @__PURE__ */ jsx("circle", { cx: "34", cy: "20", r: "2", fill: "white" }),
        /* @__PURE__ */ jsx("circle", { cx: "28", cy: "26", r: "2", fill: "white" })
      ]
    }
  );
}
function AppLogo() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex aspect-square size-8 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsx(AppLogoIcon, { className: "size-7 fill-current text-white dark:text-black" }) }),
    /* @__PURE__ */ jsx("div", { className: "ml-1 grid flex-1 text-left text-sm", children: /* @__PURE__ */ jsx("span", { className: "mb-0.5 truncate leading-tight font-semibold", children: "Tracking Analytics" }) })
  ] });
}
const getMainNavItems = (isSuperAdmin, hasAdminAccess) => {
  const items = [
    {
...
function AppSidebarHeader({
  ...
  return /* @__PURE__ */ jsx("header", { className: "flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border/50 px-6 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsx(SidebarTrigger, { className: "-ml-1 h-9 w-9 bg-gradient-to-br from-blue-500/80 to-indigo-600/80 hover:from-blue-600/90 hover:to-indigo-700/90 text-white shadow-md hover:shadow-lg transition-all duration-200 rounded-lg backdrop-blur-sm" }),
