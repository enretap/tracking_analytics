...
export default function CreateReport({ accounts }: Props) {
            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Définissez le type de rapport et les comptes associés
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-3">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Création en cours...' : 'Créer le rapport'}
                                </Button>
