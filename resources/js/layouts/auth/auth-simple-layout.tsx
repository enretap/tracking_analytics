...
export default function AuthSimpleLayout({
    ...
    return (
        <div className="relative flex min-h-svh flex-col items-center justify-center gap-6 overflow-hidden p-6 md:p-10">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-gray-900 dark:via-amber-900/20 dark:to-orange-900/20">
                {/* Animated gradient orbs */}
                <div className="absolute -left-40 top-0 h-96 w-96 animate-blob rounded-full bg-gradient-to-r from-amber-400 to-yellow-300 opacity-30 blur-3xl mix-blend-multiply filter dark:opacity-20"></div>
                <div className="animation-delay-2000 absolute -right-40 top-0 h-96 w-96 animate-blob rounded-full bg-gradient-to-r from-orange-400 to-amber-300 opacity-30 blur-3xl mix-blend-multiply filter dark:opacity-20"></div>
                <div className="animation-delay-4000 absolute -bottom-40 left-20 h-96 w-96 animate-blob rounded-full bg-gradient-to-r from-yellow-400 to-orange-300 opacity-30 blur-3xl mix-blend-multiply filter dark:opacity-20"></div>
